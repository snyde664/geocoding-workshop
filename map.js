...
JF.initialize({ apiKey: "0f777bda22b4e72e14333eabd878f17e" });
 
// Create a function to access the jotform submissions . Format: (formID, callback)
function getSubmissions() {
  JF.getFormSubmissions("223316643801046", function (responses) {
    ...
    for (var i = 0; i < responses.length; i++) {
      ...
      keys.forEach((answer) => {
        ...
        if (entry === "number8" || entry === "longitude") {
      ...
      submissionProps.geometry["coordinates"] = [
        ...
        submissionProps.properties.number8,
      ];
...
map.on("click", (e) => {
  ...
  const submitForm = (location) => {
    ...
    // description
    submission[6] = newPoint.properties.description;
    // longitude
